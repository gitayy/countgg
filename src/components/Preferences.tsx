...
export const Preferences = (props) => {
  const {
    ...
    setPrefDiscordPings,
    prefLoadFromBottom,
    setPrefLoadFromBottom,
    prefStrikeColor,
    setPrefStrikeColor,
    prefStandardizeFormat,
    setPrefStandardizeFormat,
    prefNightMode,
    setPrefNightMode,
    prefSubmitShortcut,
    setPrefSubmitShortcut,
    prefClear,
    setPrefClear,
    prefTimeSinceLastCount,
    setPrefTimeSinceLastCount,
    prefCustomStricken,
    setPrefCustomStricken,
    prefPostStyle,
    setPrefPostStyle,
    prefPostStyleMobile,
    setPrefPostStyleMobile,
    prefReplyTimeInterval,
    setPrefReplyTimeInterval,
    prefNightModeColors,
    setPrefNightModeColors,
    prefPostPosition,
    setPrefPostPosition,
    prefHideStricken,
    setPrefHideStricken,
    prefHighlightLastCount,
    setPrefHighlightLastCount,
    prefHighlightLastCountColor,
    setPrefHighlightLastCountColor,
    prefSoundOnStricken,
    setPrefSoundOnStricken,
    prefHideThreadPicker,
    setPrefHideThreadPicker,
    prefStrickenCountOpacity,
    setPrefStrickenCountOpacity,
    enabled,
    setEnabled,
    children,
  } = props
