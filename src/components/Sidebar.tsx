          ...
          {counter && user && (
            <div>
              ...
              <Menu
                ...
                onClose={handleClose}
              >
                {counter && counter.color && <><Link color={'inherit'} underline='none' href={`/counter/${counter.username}`} onClick={(e) => {e.preventDefault();navigate(`/counter/${counter.username}`);handleClose()}}><MenuItem>Profile</MenuItem></Link>
