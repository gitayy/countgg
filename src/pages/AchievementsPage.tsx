    ...
    if(!loading && !achievementsLoading && !unearnedAchievementsLoading && isMounted.current) {
      ...
      return (
        <Box sx={{ bgcolor: 'primary.light', flexGrow: 1, p: 2}}>
            <Typography sx={{mb: 1}} variant="h5">Public Achievements</Typography>
            <Grid container>
            ...
            {!counter || (counter && counter.username !== 'Reli') && <><Typography sx={{mb: 1}} variant="h5">Secret Achievements</Typography>
            <Grid container>
