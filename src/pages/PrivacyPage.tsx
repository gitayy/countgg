  ...
  return (
    <>
      <Box sx={{ bgcolor: 'background.paper', flexGrow: 1, p: 3 }}>
        ...
        <p>
          At counting.gg, accessible from counting.gg, one of our main priorities is the privacy of our visitors. This Privacy Policy
          document contains types of information that is collected and recorded by counting.gg and how we use it.
        </p>
        ...
        <p>
          ...
          information that they shared and/or collect in counting.gg. This policy is not applicable to any information collected
        ...
        <p>
          counting.gg follows a standard procedure of using log files. These files log visitors when they visit websites. All hosting
        ...
        <p>
          Like any other website, counting.gg uses 'cookies'. These cookies are used to store information including visitors'
        ...
        <p>
          ...
          respective advertisements and links that appear on counting.gg, which are sent directly to users' browser. They automatically
        ...
        <p>
          counting.gg's Privacy Policy does not apply to other advertisers or websites. Thus, we are advising you to consult the
        ...
        <p>
          The right to rectification – You have the right to request that we correct any information you believe is inaccurate. You
          also have the right to request that we complete the information you believe is incomplete.
        </p>
        ...
        <p>
          counting.gg does not knowingly collect any Personal Identifiable Information from children under the age of 13. If you think
